  ...
  const [isTapped, setIsTapped] = useState(false);
    ...
    return (
      <div className={`group bg-blue-100 mr-5 mb-5 md:mr-0 flex flex-col p-5 rounded-xl relative flex justify-center items-center ${className}`}>
        ...
        <Link href="" className="bg-white px-5 py-2 text-black/75 hover:text-white hover:bg-gradient-to-r from-cyan-500 to-blue-500 transition-all duration-300 border border-black/75 hover:border-white rounded mt-5 w-44 flex justify-center items-center">
